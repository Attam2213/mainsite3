...
export const createProject = async (req: Request, res: Response): Promise<void> => {
  try {
    ...
    const { title, budget, deadline, clientId, status, progress, serverIp, websiteUrl, paidUntil, siteStatus, monthlyRate, sshUsername, sshPassword, pm2ProcessName } = req.body;
